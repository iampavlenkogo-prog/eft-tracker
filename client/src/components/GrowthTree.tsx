...
const Stage1 = () => (
  <svg viewBox="0 0 200 220" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
    <ellipse cx="100" cy="185" rx="45" ry="12" fill="#6A3050" opacity="0.6"/>
    <path d="M95 183 Q80 190 70 200" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
    <path d="M105 183 Q118 190 128 200" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
    <path d="M100 183 Q98 160 100 130" stroke="#6A3050" strokeWidth="3" fill="none" strokeLinecap="round"/>
...
const Stage2 = () => (
  <svg viewBox="0 0 200 240" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
    <ellipse cx="100" cy="200" rx="50" ry="13" fill="#6A3050" opacity="0.6"/>
    <path d="M93 198 Q75 205 62 215" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
    <path d="M100 200 Q100 210 100 218" stroke="#6A3050" strokeWidth="2" fill="none" strokeLinecap="round"/>
    <path d="M107 198 Q123 205 136 215" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
    <path d="M100 198 Q97 165 100 110" stroke="#6A3050" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
...
const Stage3 = () => (
  <svg viewBox="0 0 240 280" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
    <ellipse cx="120" cy="248" rx="60" ry="14" fill="#6A3050" opacity="0.5"/>
    <path d="M108 246 Q85 255 68 265" stroke="#6A3050" strokeWidth="3" fill="none" strokeLinecap="round"/>
    <path d="M120 248 Q120 258 120 268" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
    <path d="M132 246 Q153 255 170 265" stroke="#6A3050" strokeWidth="3" fill="none" strokeLinecap="round"/>
    <path d="M120 246 Q116 200 118 130" stroke="#6A3050" strokeWidth="5" fill="none" strokeLinecap="round"/>
    <path d="M117 175 Q95 160 75 148" stroke="#6A3050" strokeWidth="3" fill="none" strokeLinecap="round"/>
    <path d="M118 158 Q140 142 160 132" stroke="#6A3050" strokeWidth="3" fill="none" strokeLinecap="round"/>
    <path d="M118 140 Q100 125 85 112" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
    <path d="M119 133 Q138 118 153 108" stroke="#6A3050" strokeWidth="2.5" fill="none" strokeLinecap="round"/>
...
const Stage4 = () => (
  <svg viewBox="0 0 260 300" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
    ...
    <path d="M130 270 Q125 230 128 175" stroke="#6A3050" strokeWidth="7" fill="none" strokeLinecap="round"/>
    <path d="M127 210 Q100 190 72 170" stroke="#6A3050" strokeWidth="4.5" fill="none" strokeLinecap="round"/>
    <path d="M128 195 Q155 175 182 158" stroke="#6A3050" strokeWidth="4.5" fill="none" strokeLinecap="round"/>
    <path d="M128 178 Q108 155 88 138" stroke="#6A3050" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
    <path d="M129 170 Q150 148 170 133" stroke="#6A3050" strokeWidth="3.5" fill="none" strokeLinecap="round"/>
    <path d="M128 175 Q128 148 130 118" stroke="#6A3050" strokeWidth="3" fill="none" strokeLinecap="round"/>
