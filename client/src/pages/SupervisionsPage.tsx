                        ...
                        {g.zoomLink && !isPast && (
                          <div className="flex items-center gap-3 mb-3">
                            <a href={g.zoomLink} target="_blank" rel="noopener noreferrer"
                              className="inline-flex items-center gap-2 bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white text-xs font-medium px-4 py-2 rounded-xl neu-btn-primary hover:opacity-90 transition">
                              🎥 Приєднатися до Zoom
                            </a>
                            {g.zoomPassword && (
            ...
            <>
              <div className="flex flex-wrap gap-2 mb-4">
                <button onClick={openSkillsModal}
                  className="flex items-center gap-2 bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition ml-auto">
          ...
          {pageTab === 'bookings' && (
            bookings.length === 0 ? (
              <div className="text-center py-16">
                ...
                <Link to="/slots" className="mt-4 inline-flex items-center gap-1.5 bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition">
                  Переглянути слоти →
                </Link>
              </div>
            ) : (
                      ...
                      <div className="flex flex-wrap gap-2">
                        {b.status === 'APPROVED' && zoom && (
                          <a href={zoom} target="_blank" rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white text-xs font-medium rounded-xl px-3 py-1.5 neu-btn-primary hover:opacity-90 transition">
