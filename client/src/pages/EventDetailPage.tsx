                ...
                <div>
                  ...
                  {pendingReceiptFile && (
                    <button
                      ...
                      className="mt-3 bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition disabled:opacity-50 w-full justify-center flex items-center gap-2"
                    >
                      <Upload size={16} />
            ...
            {canRegister && (
              <div>
                ...
                <button
                  ...
                  className="bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition w-full justify-center flex items-center gap-2"
                >
                  Зареєструватися
                </button>
              </div>
          ...
          <div className="relative bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col max-h-[92vh]">
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#FAF9F6] border border-[#E5DAD9] rounded-xl px-4 py-2.5 text-sm text-warm-dark placeholder:text-[#8EA082] focus:outline-none focus:border-[#7B8E5C]/60 transition neu-input"
                />
              </div>
            ...
            <div className="px-6 py-4 border-t border-sand shrink-0">
              <button
                ...
                className="bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed w-full justify-center flex items-center gap-2"
              >
                <Send size={15} />
          ...
          <div className="relative bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col max-h-[92vh]">
            ...
            <div className="px-6 py-4 border-t border-sand shrink-0">
              <button
                ...
                className="bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed w-full"
              >
