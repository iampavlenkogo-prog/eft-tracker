                    ...
                    {isExpanded && (
                      <div className="border-t border-sand px-5 py-4 space-y-4">
                        ...
                        <div>
                          ...
                          }} className="bg-gradient-to-br from-[#EB4600] to-[#CC3A00] text-white text-xs font-medium rounded-xl px-3 py-2 neu-btn-primary hover:opacity-90 transition">
                            Зберегти Zoom
                          </button>
                        </div>
        ...
        <div className="max-w-3xl">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-5 mb-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={applyFilters} className="bg-rose hover:bg-[#CC3A00] text-white text-sm font-medium rounded-xl px-4 py-2.5 transition whitespace-nowrap">
                Застосувати
              </button>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-gradient-to-br from-[#EB4600] to-[#CC3A00] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition"
              >
                Підтвердити
              </button>
            </div>
