        ...
        <div className="w-full max-w-sm">
          ...
          {step === 1 ? (
            <form onSubmit={handleStep1} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-rose hover:bg-[#A06070] text-white font-medium rounded-2xl py-3.5 transition text-sm mt-1 shadow-sm"
              >
                Далі →
              </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-rose hover:bg-[#A06070] disabled:opacity-60 text-white font-medium rounded-2xl py-3.5 transition text-sm mt-1 shadow-sm"
              >
