    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full"
          style={{ background: 'radial-gradient(circle, #F5A880 0%, transparent 70%)', opacity: 0.5 }} />
        ...
        <div className="absolute bottom-24 -left-12 w-56 h-56 rounded-full"
          style={{ background: 'radial-gradient(circle, #F5A880 0%, transparent 70%)', opacity: 0.4 }} />
        ...
        <div className="w-full max-w-sm">
          ...
          {step === 1 ? (
            <form onSubmit={handleStep1} className="space-y-3">
              ...
              {error && (
                <p className="text-[#A86060] text-sm bg-[#F8EEEE] rounded-2xl px-4 py-2.5">{error}</p>
              )}

              <button
                type="submit"
                className="w-full bg-rose hover:bg-[#D93818] text-white font-medium rounded-2xl py-3.5 transition text-sm mt-1 shadow-sm"
              >
                Далі →
              </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-rose hover:bg-[#D93818] disabled:opacity-60 text-white font-medium rounded-2xl py-3.5 transition text-sm mt-1 shadow-sm"
              >
