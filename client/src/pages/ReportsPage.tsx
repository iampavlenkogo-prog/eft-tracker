              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#FFF4EC] border border-[#C8D0B8] rounded-xl px-4 py-2.5 text-sm text-warm-dark focus:outline-none focus:border-[#A2C2BE]/60 transition neu-input"
                  />
                </div>
                <div>
