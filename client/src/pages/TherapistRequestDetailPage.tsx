        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {canRespond && (
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-br from-[#D79A95] to-[#C8857F] text-white font-medium rounded-xl px-4 py-2.5 text-sm shadow-[0_2px_10px_rgba(215,154,149,0.25)] hover:opacity-90 transition"
            >
