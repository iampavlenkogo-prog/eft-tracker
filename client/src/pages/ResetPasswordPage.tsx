...
function HeartSvg() {
  return (
    <svg width="28" height="26" viewBox="0 0 24 22" fill="#4D8A85" xmlns="http://www.w3.org/2000/svg">
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-rose hover:bg-[#5AAEAA] disabled:opacity-60 text-white font-medium rounded-xl py-3 transition text-sm"
              >
