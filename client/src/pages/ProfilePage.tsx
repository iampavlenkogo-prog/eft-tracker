    ...
    try {
      ...
      container.innerHTML = `
        <div style="padding:60px 56px;">
          <div style="font-size:20px;color:#4D8A85;margin-bottom:18px;letter-spacing:4px;">♡</div>
          ...
          ${ownItems.length > 0 ? `
            <div style="font-size:11px;font-weight:500;letter-spacing:3px;text-transform:uppercase;color:#4D8A85;margin-bottom:16px;">Мої записи</div>
            ${ownItems.map(p => `
          ...
          ${savedItems.length > 0 ? `
            <div style="font-size:11px;font-weight:500;letter-spacing:3px;text-transform:uppercase;color:#4D8A85;margin-bottom:16px;${ownItems.length > 0 ? 'margin-top:24px;' : ''}">Збережені записи</div>
            ${savedItems.map(p => `
              <div style="background:#F0EBE3;border-radius:12px;padding:20px 24px;margin-bottom:12px;">
                <div style="font-family:Georgia,serif;font-size:18px;font-style:italic;color:#2C2C2C;line-height:1.6;margin-bottom:8px;">«${p.text}»</div>
          ...
          <div style="margin-top:48px;text-align:center;">
            <div style="font-family:Georgia,serif;font-style:italic;font-size:15px;color:#4D8A85;margin-bottom:8px;">Навчання. Ріст. Зв'язок. ♡</div>
            ...
            {isEditing ? (
              ...
              <div className="space-y-3">
                {([
                  ...
                  <div key={label} className="flex gap-4 py-1.5 border-b border-[#EBF5F3] last:border-0">
          ...
          <div id="eft-dictionary" className="bg-white rounded-2xl shadow-sm p-6 scroll-mt-20">
            ...
            <div className="mb-4">
              ...
              <button
                ...
                className="mt-2 flex items-center gap-1.5 bg-gradient-to-br from-[#6BC1B6] to-[#5AAEAA] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition disabled:opacity-50"
              >
                <Plus size={14} />
                    ...
                    {editingPhraseId === phrase.id ? (
                      <div>
                        <textarea
                          ...
                          rows={2}
                          className="w-full bg-[#F1F7F7] border border-[#D5E6E5] rounded-xl px-3 py-2 text-sm text-warm-dark placeholder:text-[#8AABAB] focus:outline-none focus:border-[#4D8A85]/60 transition neu-input resize-none"
                        />
                ...
                <>
                  ...
                  <div className="relative mb-4">
                    <input
                      ...
                      className="w-full bg-[#F1F7F7] border border-[#D5E6E5] rounded-xl pl-9 pr-4 py-2 text-sm text-warm-dark placeholder:text-[#8AABAB] focus:outline-none focus:border-[#4D8A85]/60 transition neu-input"
                    />
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={pwSaving}
                className="bg-gradient-to-br from-[#6BC1B6] to-[#5AAEAA] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition disabled:opacity-50"
              >
