    ...
    try {
      ...
      container.innerHTML = `
        <div style="padding:60px 56px;">
          <div style="font-size:20px;color:#B8A8A4;margin-bottom:18px;letter-spacing:4px;">♡</div>
          ...
          <div id="eft-dictionary" className="bg-white rounded-2xl shadow-sm p-6 scroll-mt-20">
            ...
            <div className="mb-4">
              ...
              <button
                ...
                className="mt-2 flex items-center gap-1.5 bg-gradient-to-br from-[#C07888] to-[#A06070] text-white font-medium rounded-xl px-6 py-2.5 text-sm neu-btn-primary hover:opacity-90 transition disabled:opacity-50"
              >
                <Plus size={14} />
                ...
                <>
                  ...
                  <div className="relative mb-4">
                    <input
                      ...
                      className="w-full bg-[#FFF9F5] border border-[#EDE5DE] rounded-xl pl-9 pr-4 py-2 text-sm text-warm-dark placeholder:text-[#9A8878] focus:outline-none focus:border-[#B8A8A4]/60 transition neu-input"
                    />
