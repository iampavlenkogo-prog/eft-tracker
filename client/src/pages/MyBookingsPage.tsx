    ...
    <Layout>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 max-w-sm mx-auto">
          ...
          <Link to="/slots" className="inline-flex items-center gap-1.5 bg-gradient-to-br from-[#C07888] to-[#A06070] text-white text-sm font-medium rounded-xl px-5 py-2.5 neu-btn-primary hover:opacity-90 transition">
                ...
                <div className="flex flex-wrap gap-2">
                  {b.status === 'APPROVED' && zoomLink && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 bg-gradient-to-br from-[#C07888] to-[#A06070] text-white text-xs font-medium rounded-xl px-3 py-1.5 shadow-[0_2px_8px_rgba(192,100,120,0.18)] hover:opacity-90 transition"
                    >
