                    ...
                    <div className="mt-4 border-t border-sand pt-4">
                      {!isActiveUpload ? (
                        <button
                          ...
                          className="flex items-center gap-2 bg-gradient-to-br from-[#C08898] to-[#A8707E] text-white text-sm font-medium rounded-xl px-5 py-2.5 shadow-[0_2px_10px_rgba(196,133,106,0.25)] hover:opacity-90 transition"
                        >
                          <Upload size={15} />
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 border border-[#DDD5CC] bg-white text-warm-mid rounded-xl py-2 text-sm font-medium hover:bg-[#F5EFE9] hover:border-[#C08898]/30 transition"
                            >
                              Скасувати
                            </button>
                            <button
                              ...
                              className="flex-1 bg-gradient-to-br from-[#C08898] to-[#A8707E] text-white font-medium rounded-xl py-2 text-sm shadow-[0_2px_8px_rgba(196,133,106,0.25)] hover:opacity-90 transition disabled:opacity-50"
                            >
