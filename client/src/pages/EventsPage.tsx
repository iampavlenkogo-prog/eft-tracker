  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        {/* Filter tabs */}
        <div className="flex gap-1 bg-white/80 rounded-2xl p-1 border border-[#C8D0B8]/60 shadow-[0_1px_8px_rgba(160,120,100,0.06)] overflow-x-auto mb-6">
          {(['upcoming', 'completed', 'all'] as const).map(f => (
            <button
              ...
              className={filter === f
                ...
                : 'text-warm-mid hover:text-warm-dark hover:bg-[#F5F5DC] rounded-xl px-3 py-1.5 text-xs font-medium whitespace-nowrap transition'}
            >
